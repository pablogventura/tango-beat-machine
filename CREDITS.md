...
- Author: Jörg Bleymehl
- Source: https://joergbleymehl.de/en/soundfont/
...
# Instrument icon credits (Tango)

## violin.svg

- Author: gnokii (Open Clip Art Library)
- Source: https://commons.wikimedia.org/wiki/File:Violin_by_gnokii.svg
- License: public domain (CC0 / Open Clip Art dedication)

## bandoneon.svg

- Original icon for this project (square-end bandoneon with bellows and button boards).
